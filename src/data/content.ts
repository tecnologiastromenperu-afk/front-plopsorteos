...
export const prizes: Prize[] = [
  ...
  { id: "Super Pack", name: 'Super Pack MAXFL ', description: 'Super Pack MAXFL', image: premioSuperPack },
  { id: "Pack Linea Vet", name: 'Pack Linea Vet MAXFL', description: 'Pack de Linea Veterinaria Para Mascotas', image: premioPackLineaVet },
];
